...
const tableName = 'fi_approval_pending';

// Defining the schema for the model Caste
const FiApprovalPending = sequelize.define('fi_approval_pending',
{
    profile_id: {
...
FiApprovalPending.removeAttribute('id');
/*
...
module.exports = FiApprovalPending;
