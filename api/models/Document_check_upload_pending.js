...
const tableName = 'document_check_upload_pending';

// Defining the schema for the model Caste
const DocumentCheckUploadPending = sequelize.define('document_check_upload_pending',
{
    profile_id: {
...
DocumentCheckUploadPending.removeAttribute('id');
/*
...
module.exports = DocumentCheckUploadPending;
