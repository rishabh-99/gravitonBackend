...
test('CAR | Create (auth)| login cred', async () => {
...
// test('CAR | Create (auth) | Invalid input', async () => {
// /**
//  * creating a car authenticaion test 
//  * @constructor- After Authenticatoin
//  * @param {respones} api to request 
...
// test('CAR | Create (auth) | Wrong user', async () => {
// /**
//  * creating a car authenticaion test 
//  * @constructor- After Authenticatoin
//  * @param {respones} api to request 
...
// test('CAR | Create (auth) | Token Error', async () => {
// /**
//  * creating a car authenticaion test 
//  * @constructor- After Authenticatoin
//  * @param {respones} api to request 
...
// test('CAR | Create (auth) | Invalid aadhar', async () => {
// /**
//  * creating a car authenticaion test 
//  * @constructor- After Authenticatoin
//  * @param {respones} api to request 
...
//         "gurantor_relation": "sffdfd",
//         "gurantor_realtedpan": "QWETY1234O",
//         "gurantor_realtedaadhar": "2222222222302",
//         "gurantortype_id": 1
//       },
//       "loanModel": []
//     })
